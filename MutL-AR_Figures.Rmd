...
IP_Rep1_200bp <- LoadTrackFile(track.file = "IP1_SES_200bin.bw",format = "bw",
                                            region = "NC_000913.3:0-4641652",extend = 0)
IP_Rep1_200bp$Sample <- "IP-Rep1"

IP_Rep2_200bp <- LoadTrackFile(track.file = "IP2_SES_200bin.bw",format = "bw",
                                            region = "NC_000913.3:0-4641652",extend = 0)
...
(A + B + C) / (D + E + plot_spacer()) & theme(plot.margin = margin(0,5,0,0))
